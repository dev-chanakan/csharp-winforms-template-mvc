...
GO
PRINT N'The following operation was generated from a refactoring log file 631692db-a983-40ca-b60d-408fc0e45bdc';

PRINT N'Rename [dbo].[Quotations].[CreatedBy] to CreatedByUserCode';


GO
EXECUTE sp_rename @objname = N'[dbo].[Quotations].[CreatedBy]', @newname = N'CreatedByUserCode', @objtype = N'COLUMN';
...
GO
ALTER TABLE [dbo].[Quotations] DROP COLUMN [ExpiredDate];
