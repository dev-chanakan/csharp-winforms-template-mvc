...
GO
PRINT N'Altering [dbo].[QuotationItems]...';


GO
ALTER TABLE [dbo].[QuotationItems] ALTER COLUMN [Description] NVARCHAR (MAX) NULL;

ALTER TABLE [dbo].[QuotationItems] ALTER COLUMN [ProductName] NVARCHAR (MAX) NOT NULL;
